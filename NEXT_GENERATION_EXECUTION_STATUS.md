...
| RU08 | `7ce6b818c6ea3c481f3b0c5da8dc86f5c88b20ff` | `ecea29df8b85a04d64e83640f782e32a26701ebc` | CLOSED / REMOTE QUALIFIED | Complete user workflow E1-E6, StageService, STOP predicates, restart truth, atomic stage completion, deterministic accepted-stage projection, verified continuation cut | Full pytest PASS, Ruff PASS, Mypy PASS, deterministic standalone + release validator + smoke/deep self-tests PASS, independent clean-room rebuild/raw identity PASS; Actions run `34758253356` | RU13-A | None | RU09 |
| RU09 | `ecea29df8b85a04d64e83640f782e32a26701ebc` | `530a490b2659959f8908163fa65516b6aa70933c` | CLOSED / REMOTE QUALIFIED | Exact-cut evidence-backed report, FACT/INTERPRETATION/PROPOSAL/UNKNOWN separation, proposed remediation DAG, Q09 completeness, deterministic JSON/Markdown/HTML bundle, manifest/receipt/tamper verification, report/remediation CLI | 838 passed, Ruff PASS, Mypy PASS, release validator + standalone smoke/deep PASS, independent clean-room rebuild/raw identity PASS; Actions run `34760875201` | RU08 | None | RU12-A |
| RU12-A | `530a490b2659959f8908163fa65516b6aa70933c` | TBD | IN_PROGRESS | Basic verified coverage/evidence UX, CLI blocker/inspect commands | Q12-A pending | RU09 | None | RU13-B |
